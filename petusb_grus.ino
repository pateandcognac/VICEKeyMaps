...
{
	KEY_1,      KEY_3,      KEY_5,        KEY_7,        KEY_9,        KEY_MINUS,    KEY_HOME,    KEY_0,
	KEY_2,      KEY_4,      KEY_6,        KEY_8,        KEY_0,        KEY_0,        KEY_0,       KEY_BACKSPACE,
	KEY_Q,      KEY_E,      KEY_T,        KEY_U,        KEY_O,        KEY_BACKSLASH,KEY_F7,      KEY_F9,
	KEY_W,      KEY_R,      KEY_Y,        KEY_I,        KEY_P,        KEY_0,        KEY_F8,      KEYPAD_SLASH,
	KEY_A,      KEY_D,      KEY_G,        KEY_J,        KEY_L,        KEY_0,        KEY_F4,      KEY_F6,
	KEY_S,      KEY_F,      KEY_H,        KEY_K,        KEY_F11,      KEY_0,        KEY_F5,      KEYPAD_ASTERIX,
	KEY_Z,      KEY_C,      KEY_B,        KEY_M,        KEY_SEMICOLON,KEY_ENTER,    KEY_F1,      KEY_F3,
	KEY_X,      KEY_V,      KEY_N,        KEY_PAGE_UP,    KEY_SLASH,    KEY_0,      KEY_F2,      KEYPAD_PLUS,
	KEY_0,      KEY_F12,    KEY_RIGHT_BRACE,KEY_0,      KEY_PERIOD,   KEY_0,        KEY_F10,     KEYPAD_MINUS,
	KEY_TAB,    KEY_LEFT_BRACE,KEY_SPACE, KEY_COMMA,    KEY_ESC,      KEY_0,        KEY_DELETE,  KEY_PAGE_DOWN
};
...
/*
  case 60: // Question Mark 
      // pressed
      if(state == LOW)
      {
         //check for active shift to send alt169 left bracket, for petscii checker
         if (lShift || rShift)
         {
          Keyboard.set_modifier(MODIFIERKEY_ALT);
          Keyboard.set_key1(KEYPAD_1);
          Keyboard.set_key2(KEYPAD_6);
          Keyboard.set_key3(KEYPAD_9);
         // Keyboard.set_key4(KEYPAD_0);
         // Keyboard.set_key5(KEYPAD_0); 
         // Keyboard.set_key6(KEYPAD_0);  
          Keyboard.send_now();  
